...
# ✅ 데이터 경로 설정
base_path = "/content/drive/MyDrive/hepscope/AML_val_GSE116256/6_samples/filtered_gene/small/"
...
# ✅ Train Data (GSE185381)
train_aml_Malig = load_csv('train_Malig_small.csv')
train_aml_Normal = load_csv('train_Normal_small.csv')
...
val_aml_Normal = load_csv("val_Normal_small.csv")
val_aml_Malig = load_csv("val_Malig_small.csv")
...
external_aml_Normal = load_csv("external_Normal_small.csv")
external_aml_Malig = load_csv("external_Malig_small.csv")
...
# ✅ Train Model
mlp_model.fit(train_aml_X, train_aml_Y,
